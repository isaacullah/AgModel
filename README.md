...
4. Deer produces 1580 kcal/kg, with 100 kg yield per animal, and a return rate of abotu 10000 kcal/hr once encountered. Two fawns per year are assumed and three days average search time when there are 1000 animals in the vicinity. Some of these are estimates from Bettinger 1991, "Hunter-Gatherers," and some come from [USDA nutrition info for vennison](http://ndb.nal.usda.gov/ndb/foods/show/5421?fg=&man=&lfacet=&count=&max=25&sort=&qlookup=game+meat&offset=25&format=Full&new=&measureby=).
